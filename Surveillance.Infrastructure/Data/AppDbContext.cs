...
namespace Surveillance.Infrastructure.Data    
{
    ...
    { 
       public AppDbContext(DbContextOptions<AppDbContext> options) : base(options) { }
        ...
        // ===================================================== // LMIS TRANSACTION TABLES // ========================//
        public DbSet<Sample> Samples => Set<Sample>(); 
        public DbSet<CaseRecordLabTest> CaseRecordLabTests => Set<CaseRecordLabTest>(); 
        public DbSet<LabResult> LabResults => Set<LabResult>(); 
        // ===================================================== // MANY-TO-MANY TABLES // ===========================//
        public DbSet<DiseaseSymptom> DiseaseSymptoms => Set<DiseaseSymptom>(); 
        public DbSet<DiseaseLabTest> DiseaseLabTests => Set<DiseaseLabTest>(); 
        public DbSet<LabTestSampleType> LabTestSampleTypes => Set<LabTestSampleType>(); 
        public DbSet<CaseRecordSymptom> CaseRecordSymptoms => Set<CaseRecordSymptom>();
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Single-column index for count & simple facility filtering
            builder.Entity<CaseRecord>()
       .HasIndex(c => c.FacilityId)
       .HasDatabaseName("IX_CaseRecords_FacilityId");

            // 📊 Index for facility case lookups (Facility.razor pagination)
            builder.Entity<CaseRecord>()
                .HasIndex(c => new { c.FacilityId, c.CreatedDate })
                .HasDatabaseName("IX_CaseRecords_FacilityId_CreatedDate");

            // Dashboard: Filter by IsCommunicable + OnsetDate
            builder.Entity<CaseRecord>()
                .HasIndex(c => new { c.IsCommunicable, c.OnsetDate })
                .HasDatabaseName("IX_CaseRecords_IsCommunicable_OnsetDate");

            // Notifications: Filter by FacilityId + order by Timestamp
            builder.Entity<Notification>()
                .HasIndex(n => new { n.FacilityId, n.Timestamp })
                .HasDatabaseName("IX_Notifications_FacilityId_Timestamp");

            // Notifications: Filter by CaseRecordId + Type (deduplication)
            builder.Entity<Notification>()
