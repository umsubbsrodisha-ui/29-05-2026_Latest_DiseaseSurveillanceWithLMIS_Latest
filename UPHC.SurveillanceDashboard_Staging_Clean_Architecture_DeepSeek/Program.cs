...
using Surveillance.Infrastructure.Identity;
using Surveillance.Infrastructure.Repositories;
using Surveillance.Infrastructure.Services;
...
builder.Services.AddMediatR(cfg =>
{
    cfg.RegisterServicesFromAssembly(
        typeof(
            Surveillance.Application.Features.Dashboard.Queries
                .GetDashboardSummaryQuery).Assembly);

    cfg.RegisterServicesFromAssembly(
        typeof(
            Surveillance.Infrastructure.Notifications
                .DashboardDataRefreshedHandler).Assembly);
});
...
if (app.Environment.IsDevelopment())
{
    ...
    // Seed Identity + Roles + Facility Users
...
//builder.Services.AddMediatR(cfg =>
//{
//    cfg.RegisterServicesFromAssembly(typeof(Surveillance.Application.Features.Dashboard.Queries.GetDashboardSummaryQuery).Assembly);
//    cfg.RegisterServicesFromAssembly(typeof(Surveillance.Infrastructure.Notifications.DashboardDataRefreshedHandler).Assembly);
//});
